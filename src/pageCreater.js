        ...
        switch (obj.getRole()) {
            case "Manager":
                ...
                <div>
                    <ul class="list-none my-2">
                        <li class="border my-1 py-1 px-2"><span class="font-semibold">ID:</span> ${obj.getID()}</li>
                        <li class="border my-1 py-1 px-2"><span class="font-semibold">Office Number:</span> ${obj.officeNumber}</li>
                        <li class="border my-1 py-1 px-2"><span class="font-semibold">Email:</span>  <a class="hover:text-blue-700" href="mailto:${obj.getEmail()}">${obj.getEmail()}</a></li>
                    </ul>
                </div>
            </div>`
                break;
            case "Engineer":
                ...
                <div>
                    <ul class="list-none my-2">
                        <li class="border my-1 py-1 px-2"><span class="font-semibold">ID:</span> ${obj.getID()}</li>
                        <li class="border my-1 py-1 px-2"><span class="font-semibold">Email:</span>  <a class="hover:text-blue-700" href="mailto:${obj.getEmail()}">${obj.getEmail()}</a></li>
                        <li class="border my-1 py-1 px-2"><span class="font-semibold">Github:</span>  <a class="hover:text-blue-700" href="https://github.com/${obj.getGithub()}">${obj.getGithub()}</a></li>
                    </ul>
                </div>
            </div>`
                break;
            case "Intern":
                ...
                <div>
                    <ul class="list-none my-2">
                        <li class="border my-1 py-1 px-2"><span class="font-semibold">ID:</span> ${obj.getID()}</li>
                        <li class="border my-1 py-1 px-2"><span class="font-semibold">School:</span> ${obj.getSchool()}</li>
                        <li class="border my-1 py-1 px-2"><span class="font-semibold">Email:</span>  <a class="hover:text-blue-700" href="mailto:${obj.getEmail()}">${obj.getEmail()}</a></li>
                    </ul>
                </div>
            </div>`
